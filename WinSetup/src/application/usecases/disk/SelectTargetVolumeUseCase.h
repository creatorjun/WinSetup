// src/application/usecases/disk/SelectTargetVolumeUseCase.h
#pragma once

#include <abstractions/usecases/ISelectTargetVolumeUseCase.h>
...
namespace winsetup::application {
    ...
    class SelectTargetVolumeUseCase final : public abstractions::ISelectTargetVolumeUseCase {
    public:
        explicit SelectTargetVolumeUseCase(
        ...
        ~SelectTargetVolumeUseCase() override = default;
